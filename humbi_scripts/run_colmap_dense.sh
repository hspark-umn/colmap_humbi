...
cp ~/bin/mask_for_dense.py .

colmap image_undistorter --image_path $IMAGE_PATH --input_path $PROJECT_PATH --output_path dense --output_type COLMAP --max_image_size 1920

#cp $IMAGE_PATH/* dense/images/

python mask_for_dense.py
